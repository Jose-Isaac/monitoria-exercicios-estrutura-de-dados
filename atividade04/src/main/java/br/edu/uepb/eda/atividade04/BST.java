...
public class BST implements BST_IF {
	...
	public Integer[] preOrder() {
		Integer[] results = new Integer[size(root)];
		preOrderRecursive(root, results, new Index());
		return results;
	}

	private void preOrderRecursive(Node root, Integer[] result, Index i) {
		if (root != null) {
	...
	private void orderRecursive(Node root, Integer[] result, Index i) {
		if (root != null) {
	...
	private void postOrderRecursive(Node root, Integer[] result, Index i) {
		if (root != null) {
