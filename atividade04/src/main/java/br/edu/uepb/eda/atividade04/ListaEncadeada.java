...
public class ListaEncadeada implements ListaEncadeada_IF {
	...
	private Integer toArrayRecursivo(Integer[] resultado, ListaEncadeada listaEncadeada, int index) {

	     if (!listaEncadeada.isEmpty()) {
	          resultado[index] = listaEncadeada.data;
	          toArrayRecursivo(resultado, listaEncadeada.next, index+1);
	       }
	     return index;	
	}
