...
public class BrincandoComEstruturas {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * Estou considerando que na árvore binária de busca não terão elementos repitidos
		 */
		...
		System.out.println(Arrays.toString(minhaArvore.preOrder()).equals(Arrays.toString(new int[]{8,6,2,7,10,9,11})));

		System.out.println(Arrays.toString(minhaArvore.order()).equals(Arrays.toString(new int[]{2,6,7,8,9,10,11})));
		
		System.out.println(Arrays.toString(minhaArvore.postOrder()).equals(Arrays.toString(new int[]{2,7,6,9,11,10,8})));
